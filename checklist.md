...
- ?????`docs/fund-workbench-spec.md` FR-F08?FR-F09?????
- ???`feature/fund-strategy-enhance`
- ????????????????????????????????????????????????????????????????
...
- `corepack pnpm typecheck && corepack pnpm lint && corepack pnpm build`
- ?? `/api/fund-portfolio?codes=510300,110022&mode=range&min_weights=45,25&max_weights=65,45&range=1y`?????????????????????????
- ?? `/api/fund-dca?codes=510300,110022&amounts=1000,1000&range=1y&frequency=monthly`???????????????????
- ?? `/api/fund-dca?code=510300&range=1y&frequency=monthly&amount=1000`??? `payday_comparison` ????????????
- ????????????????????????????????????

### ????

- ?????2026-09-10
- ???F16 ??????????????????`typecheck`?`lint`?`build` ????
